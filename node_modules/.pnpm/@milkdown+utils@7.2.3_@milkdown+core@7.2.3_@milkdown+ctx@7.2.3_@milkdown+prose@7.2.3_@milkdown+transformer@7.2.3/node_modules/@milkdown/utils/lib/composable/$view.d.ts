...
export declare const $view: <T extends $Mark | $Node, V extends NodeViewConstructor | MarkViewConstructor = GetConstructor<T>>(type: T, view: (ctx: Ctx) => V) => $View<T, V>;
export declare const $viewAsync: <T extends $Mark | $Node, V extends NodeViewConstructor | MarkViewConstructor = GetConstructor<T>>(type: T, view: (ctx: Ctx) => Promise<V>, timerName?: string) => import("./utils").WithTimer<$View<T, V>>;
