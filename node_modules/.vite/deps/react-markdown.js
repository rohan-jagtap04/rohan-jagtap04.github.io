...
import {
  normalizeUri
} from "./chunk-3WB6C55U.js";
import {
  definitions
} from "./chunk-TA2VV6EU.js";
import {
  VFile,
  remarkParse,
  unified
} from "./chunk-FHNZSWKF.js";
import "./chunk-X4UWMFBO.js";
import {
  visit
} from "./chunk-C3ENBVE7.js";
...
// node_modules/.pnpm/react-markdown@8.0.7_@types+react@18.2.14_react@18.2.0/node_modules/react-markdown/lib/uri-transformer.js
...
// node_modules/.pnpm/react-markdown@8.0.7_@types+react@18.2.14_react@18.2.0/node_modules/react-markdown/lib/react-markdown.js
...
// node_modules/.pnpm/react-markdown@8.0.7_@types+react@18.2.14_react@18.2.0/node_modules/react-markdown/lib/rehype-filter.js
...
// node_modules/.pnpm/react-markdown@8.0.7_@types+react@18.2.14_react@18.2.0/node_modules/react-markdown/lib/ast-to-react.js
...
function toReact(context, node, index, parent) {
  ...
  if (node.properties) {
    for (property in node.properties) {
      if (own2.call(node.properties, property)) {
  ...
  const component = options.components && own2.call(options.components, name) ? options.components[name] : name;
...
function addProperty(props, prop, value, ctx) {
  ...
  if (info.space && info.property) {
    props[own2.call(hastToReact, info.property) ? hastToReact[info.property] : info.property] = result;
...
function ReactMarkdown(options) {
  for (const key in deprecated) {
    if (own3.call(deprecated, key) && own3.call(options, key)) {
